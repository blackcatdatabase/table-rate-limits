...
| Pkg folder | [packages\rate-limits](https://github.com/blackcatacademy/blackcat-database/blob/main/packages/rate-limits) | Repo location |
...
pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package rate-limits -Apply

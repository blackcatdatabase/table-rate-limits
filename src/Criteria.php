...
final class Criteria extends BaseCriteria
{
    ...
    {
        return [ 'id', 'subject_type', 'subject_id', 'name', 'window_size_sec', 'limit_count', 'active', 'created_at' ];
    }
    ...
    {
        $x = [ 'id', 'subject_type', 'subject_id', 'name', 'window_size_sec', 'limit_count', 'active', 'created_at' ];
    ...
    public static function fromDb(
        ...
        if (\method_exists(\BlackCat\Database\Packages\RateLimits\Definitions::class, 'softDeleteColumn')) {
            $soft = \BlackCat\Database\Packages\RateLimits\Definitions::softDeleteColumn();

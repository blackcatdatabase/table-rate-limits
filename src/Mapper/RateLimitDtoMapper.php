...
namespace BlackCat\Database\Packages\RateLimits\Mapper;

use BlackCat\Database\Packages\RateLimits\Dto\RateLimitDto;
use BlackCat\Database\Packages\RateLimits\Definitions;
use DateTimeZone;
use BlackCat\Database\Support\DtoHydrator;

/**
 * Bidirectional mapper between DB rows and DTO RateLimitDto:
...
final class RateLimitDtoMapper
{
    ...
    /** @var string[] */
    private const INT_COLS    = [ 'id', 'window_size_sec', 'limit_count' ];
    /** @var string[] */
     ...
     * @return RateLimitDto
     */
    public static function fromRow(array $row): RateLimitDto
    {
        /** @var RateLimitDto */
    ...
    public static function fromRowOrNull(?array $row): ?RateLimitDto
    {
     ...
     *
     * @param RateLimitDto   $dto
     * @param string[]|null   $onlyProps  optional whitelist of DTO properties to serialize
     * @return array<string,mixed>
     */
    public static function toRow(RateLimitDto $dto, ?array $onlyProps = null): array
    {
    ...
    public static function toRowNonNull(RateLimitDto $dto, ?array $onlyProps = null): array
    {
     ...
     * @return array<string,mixed>
     */
    public static function diff(RateLimitDto $dto, array $original, array $ignore = [], bool $coerce = true): array
    {
        $now = self::toRow($dto);
     ...
     * @return array<int,RateLimitDto>
     */
    public static function hydrateList(array $rows): array
    {
        /** @var array<int,RateLimitDto> */
    ...
    /** @return array<string,mixed> */
    public static function toSafeArray(RateLimitDto $dto): array
    {
        $row = self::toRow($dto);
     ...
     * @return \Generator<int,RateLimitDto>
     */

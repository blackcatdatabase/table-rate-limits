...
{
    public function name(): string { return 'table-rate_limits'; }
    public function table(): string { return 'rate_limits'; }
...
SQL;
    ...
    public function status(Database $db, SqlDialect $d): array
    {
        ...
        $expectedIdx = [ 'idx_rate_limits_active' ];
        if ($d->isMysql()) {
    ...
    public function info(): array
    {
        return [
            ...
            'indexes'     => [ 'idx_rate_limits_active' ],
            'foreignKeys' => [],
        ];
    }
}

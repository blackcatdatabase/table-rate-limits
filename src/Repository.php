...
use BlackCat\Database\Packages\RateLimits\Repository\RateLimitRepository;
...
final class Repository
{
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\RateLimits\Dto\RateLimitDto|null
    {
        return $this->repo->getByUnique($keys, $asDto);
    }

    /** @return array<string,mixed>|\BlackCat\Database\Packages\RateLimits\Dto\RateLimitDto|null */
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\RateLimits\Dto\RateLimitDto|null
    {

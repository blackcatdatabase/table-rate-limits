...
namespace BlackCat\Database\Packages\RateLimits;
...
use BlackCat\Database\Packages\RateLimits\Repository\RateLimitRepository as GeneratedRepository;
...
{
  private RateLimitRepositoryInterface $repo;
  ...
  public function __construct(private Database $db)
  {
    ...
    public function _setRepositoryForTests(RepoContract $repo): void
    {
        ...
        if (!$repo instanceof RateLimitRepositoryInterface) {
            // Allow any repo that conforms to the interface even if not generated
            throw new \InvalidArgumentException('Expected RateLimitRepositoryInterface');
        }
        $this->repo = $repo;
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\RateLimits\Dto\RateLimitDto|null { return $this->repo->getByUnique($keys, $asDto); }
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\RateLimits\Dto\RateLimitDto|null { return $this->repo->getById($id, $asDto); }
